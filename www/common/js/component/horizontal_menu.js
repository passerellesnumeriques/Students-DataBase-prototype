if (typeof pn != 'undefined') {
	...
	pn.add_stylesheet("/static/common/js/component/context_menu.css");
}
...
function horizontal_menu(menu) {
	...
	t.showMoreMenu = function() {
		pn.add_javascript("/static/common/js/component/context_menu.js", function() {
	...
	t.update();
	listenEvent(window,'resize',function() { t.update(); });
}