...
$header = new SubPageHeader($this, '/static/user_management/access_list_32.png', get_locale("Role").": <span style='font-family:Courrier New;font-weight:bold;font-style:italic'>".$role["name"]."</span>");
if ($can_edit) {
...
function um_rights_save() {
	...
	ajax.post_parse_result("/dynamic/user_management/service/save_role_rights?lock=<?php echo $lock_id?>", data, function(result) {
		if (result != null)
			location.reload();
		else {
