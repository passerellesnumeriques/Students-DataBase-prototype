...
$list->build("<button onclick='popup_page(\"".get_locale("Add user")."\",\"/static/common/images/add.png\",\"user_management\",\"add_user\");return false'><img src='/static/common/images/add.png' style='vertical-align:bottom'/>".get_locale("Add user")."</button>");
?>